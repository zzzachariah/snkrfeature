...
export function Dropdown({ label, options, onSelect }: { label: string; options: string[]; onSelect: (value: string) => void }) {
  ...
  return (
    <div className="relative">
      <button type="button" className="interactive-soft inline-flex items-center gap-2 rounded-xl bg-[rgb(var(--glass-bg)/0.62)] px-3 py-2 text-sm premium-border" onClick={() => setOpen((o) => !o)}>
